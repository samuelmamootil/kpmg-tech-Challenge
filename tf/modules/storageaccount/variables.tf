...
variable "enable_https_traffic" {
  description = "Boolean flag which controls if  https is enabled."
  default     = true
}

variable "storage_account_name" {
  description = "The name of the azure storage account"
  default     = "samtestdkwip001"
}
...
variable "lifecycles" {
  ...
  # type        = list(object({ rule_name = string, prefix_match = set(string), tier_to_cool_after_days = number, tier_to_archive_after_days = number, delete_after_days = number, snapshot_delete_after_days = number }))
  # default     = []
}
